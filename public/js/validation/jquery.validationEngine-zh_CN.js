    ...
    $.validationEngineLanguage = {
        newLang: function() {
            $.validationEngineLanguage.allRules = {
                ...
                "sku": {
                    "regex": /^[0-9a-zA-Z]{2}-[0-9a-zA-Z]{3}-[0-9a-zA-Z]{3}$/,
                    "alertText": "* 无效的 SKU 格式"
                },
                "space": {
                    "regex": /^[^\s]{6,16}$/,
                    "alertText": "* 无效的 SKU 格式"
                ...
                */
                "valideRoleOnly": {
                    "url": "check/check-role-only",
                    "alertText": "* 此角色标识已存在",
                    "alterTextOk": "* 此角色标识可使用",
                    "alterTextLoad": "* 正在验证此角色标识是否存在，请稍等。。。"
                },
                "valideUserOnly": {
                    "url": "check/check-user-only",
                    "alertText": "* 此用户名已存在",
                    "alterTextOk": "* 此用户名可使用",
                    "alterTextLoad": "* 正在验证此用户是否存在，请稍等。。。"
                }
